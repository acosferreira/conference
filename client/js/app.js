Participant_Sessionsfunction getSessionList(success, error) {
  var soql = "SELECT Session__r.Id, Session__r.Name FROM Participant_Sessions__c";
                ...
                '<div class="content">' +
                    '<div class="card">' +
                        '<ul class="table-view">' +
                            ...
                            '</li>' +
                            '<li class="table-view-cell">Participant: ' +
                                session.Participant__r.First_Name__c +
                            '</li>' +
                            '<li class="table-view-cell">' +
